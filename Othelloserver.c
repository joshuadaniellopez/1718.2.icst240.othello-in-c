...
int main(int argc, char* argv[])
{
	...
	*/
    ...
    printf("Othello Server starting ...\n");
    ...
    // Mark the socket so it will listen for incoming connections
		...
		printf("Othello Server listening to port %d ...\n", port_no);
		...
		printf("Other Player (White O) succesfully connected ...\n");    
		// Communicate
